...
|------------|-------------|
| [bitcoin-auth](https://github.com/b-open-io/bitcoin-auth) | Message signing and verification using Bitcoin keys for authentication |
...
| Repository | Description |
|------------|-------------|
| [go-overlay-services](https://github.com/b-open-io/go-overlay-services) | Core overlay services engine in Go |
| [go-overlay-fiber](https://github.com/b-open-io/go-overlay-fiber) | Fiber framework integration for overlay services |
| [go-overlay-discovery-services](https://github.com/b-open-io/go-overlay-discovery-services) | Service discovery for overlay networks |
| [overlay](https://github.com/b-open-io/overlay) | Main overlay implementation |
...
| Repository | Description |
|------------|-------------|
| [bsv-mcp](https://github.com/b-open-io/bsv-mcp) | MCP (Model Context Protocol) server for Bitcoin SV |
| [bsv-skills](https://github.com/b-open-io/bsv-skills) | Claude Code plugin for core BSV blockchain operations |
| [1sat-skills](https://github.com/b-open-io/1sat-skills) | Claude Code plugin for 1Sat Ordinals NFT operations |
| [gemskills](https://github.com/b-open-io/gemskills) | Gemini integration skills for Claude Code |
| [product-skills](https://github.com/b-open-io/product-skills) | Claude Code skills for SEO, legal compliance, and launch prep |
| [claude-peacock](https://github.com/b-open-io/claude-peacock) | Visual project awareness plugin for Claude Code |
| [claude-plugins](https://github.com/b-open-io/claude-plugins) | Plugin marketplace for b-open-io Claude Code plugins |
...
- Website: [bopen.io](https://bopen.io)
- Twitter: [@1satordinals](https://twitter.com/1satordinals)
